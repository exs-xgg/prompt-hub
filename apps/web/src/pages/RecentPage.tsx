...
export default function RecentPage() {
  ...
  if (recentIds.length === 0 && !loading) {
    return (
      <div className="max-w-5xl mx-auto">
        <h1 className="text-2xl font-bold text-slate-900 mb-2">Recent</h1>
        <p className="text-slate-500 text-sm mb-6">Recently viewed prompts will appear here.</p>
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-8 text-center text-slate-600">
          <p>You haven&apos;t viewed any prompts yet.</p>
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <h1 className="text-2xl font-bold text-slate-900 mb-2">Recent</h1>
      <p className="text-slate-500 text-sm mb-6">Recently viewed prompts.</p>
      {loading ? (
